...
import static com.akaliacius.demos.vertx_timer_service.utils.Constants.ACTION_UPDATE;
import static com.akaliacius.demos.vertx_timer_service.utils.EventBusUtils.setActionAndTimeout;
import static java.util.Optional.empty;

public class TimerUpdateHandler implements Handler<RoutingContext> {

  private static final Logger logger = LoggerFactory.getLogger(TimerUpdateHandler.class);
  ...
  public void handle(RoutingContext context) {
    ...
    eventBus.<JsonObject>request(EventBusMap.TIMER_MANAGER, json, setActionAndTimeout(ACTION_UPDATE, empty()), reply -> {
      if(reply.succeeded()){
